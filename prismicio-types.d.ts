...
type BlogPostDocumentDataSlicesSlice = CallToActionSlice | ScrollerSlice | ContentSlice | ImageWithTextSlice | HeroSlice
...
interface GalleryItemDocumentData {
	 ...
	 */
	related_content: prismic.ContentRelationshipField<"blog_post"> | prismic.ContentRelationshipField<"portfolio">;
}
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type GalleryItemDocument<Lang extends string = string> = prismic.PrismicDocumentWithUID<Simplify<GalleryItemDocumentData>, "gallery_item", Lang>;

type HomepageDocumentDataSlicesSlice = ReviewsSlice | RecentsSlice | CallToActionSlice | ImageWithTextSlice | ContentSlice | ScrollerSlice | HeroSlice
...
type LocationDocumentDataSlicesSlice = ReviewsSlice | RecentsSlice | HeroSlice | ContentSlice | ImageWithTextSlice | CallToActionSlice
...
type PageDocumentDataSlicesSlice = EmbedSlice | ReviewsSlice | LocationsSlice | RecentsSlice | GallerySlice | FormSlice | CallToActionSlice | ScrollerSlice | ContentSlice | ImageWithTextSlice | HeroSlice
...
type PortfolioDocumentDataSlicesSlice = EmbedSlice | RecentsSlice | CallToActionSlice | ScrollerSlice | ImageWithTextSlice | ContentSlice
...
type ProductDocumentDataSlicesSlice = EmbedSlice | CallToActionSlice | RecentsSlice | ScrollerSlice | ImageWithTextSlice | ContentSlice
...
interface ProductDocumentData {
	 ...
	 */
	status: prismic.SelectField<"no status" | "in stock" | "low stock" | "backordered" | "out of stock" | "discontinued", "filled">;
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type ProductTypeDocument<Lang extends string = string> = prismic.PrismicDocumentWithUID<Simplify<ProductTypeDocumentData>, "product_type", Lang>;

type ServiceDocumentDataSlicesSlice = RecentsSlice | CallToActionSlice | ScrollerSlice | ImageWithTextSlice | HeroSlice | ContentSlice
...
export interface SettingsDocumentDataFooterSocialsItem {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/link
	 */
	social_url: prismic.LinkField<string, string, unknown, prismic.FieldState, never>;
}
...
interface SettingsDocumentData {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
	 */
	footer_socials: prismic.GroupField<Simplify<SettingsDocumentDataFooterSocialsItem>>;
...
export type AllDocumentTypes = BlogPostDocument | BrandDocument | GalleryItemDocument | HomepageDocument | LocationDocument | PageDocument | PortfolioDocument | ProductDocument | ProductTypeDocument | ServiceDocument | SettingsDocument;
...
export interface CallToActionSliceProductRecommendationPrimaryProductsItem {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/content-relationship
	 */
	product: ContentRelationshipFieldWithData<[{"id":"product","fields":["title","featured_image","status","description","excerpt"]}]>;
}
...
export interface CallToActionSliceDefaultPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/select
	 */
	button_color: prismic.SelectField<"default" | "secondary" | "outline" | "ghost" | "link" | "destructive">;
}
...
export interface CallToActionSliceFeaturedGridItem {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/select
	 */
	icon: prismic.SelectField<"RiQuestionnaireFill" | "GiHomeGarage" | "FaToolbox">;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type CallToActionSliceFeaturedGrid = prismic.SharedSliceVariation<"featuredGrid", Simplify<CallToActionSliceFeaturedGridPrimary>, Simplify<CallToActionSliceFeaturedGridItem>>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type CallToActionSliceSocial = prismic.SharedSliceVariation<"social", Simplify<CallToActionSliceSocialPrimary>, Simplify<CallToActionSliceSocialItem>>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type CallToActionSliceBrandGrid = prismic.SharedSliceVariation<"brandGrid", Simplify<CallToActionSliceBrandGridPrimary>, Simplify<CallToActionSliceBrandGridItem>>;
...
export interface CallToActionSliceProductTypeGridItem {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/content-relationship
	 */
	product_type: prismic.ContentRelationshipField<"product_type"> | prismic.ContentRelationshipField<"product">;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type CallToActionSliceProductTypeGrid = prismic.SharedSliceVariation<"productTypeGrid", Simplify<CallToActionSliceProductTypeGridPrimary>, Simplify<CallToActionSliceProductTypeGridItem>>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type CallToActionSliceServicesGrid = prismic.SharedSliceVariation<"servicesGrid", Simplify<CallToActionSliceServicesGridPrimary>, Simplify<CallToActionSliceServicesGridItem>>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type CallToActionSliceExpo = prismic.SharedSliceVariation<"expo", Simplify<CallToActionSliceExpoPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type CallToActionSlicePromotion = prismic.SharedSliceVariation<"promotion", Simplify<CallToActionSlicePromotionPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type CallToActionSliceLogos = prismic.SharedSliceVariation<"logos", Simplify<CallToActionSliceLogosPrimary>, Simplify<CallToActionSliceLogosItem>>;
...
export interface CallToActionSliceProductRecommendationPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
	 */
	products: prismic.GroupField<Simplify<CallToActionSliceProductRecommendationPrimaryProductsItem>>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type CallToActionSliceProductRecommendation = prismic.SharedSliceVariation<"productRecommendation", Simplify<CallToActionSliceProductRecommendationPrimary>, never>;

/**
 * Slice variation for *CallToAction*
 */
type CallToActionSliceVariation = CallToActionSliceDefault | CallToActionSliceFeaturedGrid | CallToActionSliceSocial | CallToActionSliceBrandGrid | CallToActionSliceProductTypeGrid | CallToActionSliceServicesGrid | CallToActionSliceExpo | CallToActionSlicePromotion | CallToActionSliceLogos | CallToActionSliceProductRecommendation
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type FormSliceEstimate = prismic.SharedSliceVariation<"estimate", Simplify<FormSliceEstimatePrimary>, never>;
...
export interface HeroSliceDefaultItem {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/select
	 */
	button_color: prismic.SelectField<"default" | "secondary" | "outline" | "ghost" | "link" | "destructive", "filled">;
}
...
export interface ImageWithTextSliceDefaultPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/link
	 */
	image_link: prismic.LinkField<string, string, unknown, prismic.FieldState, never>;
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/link
	 */
	call_to_action: prismic.Repeatable<prismic.LinkField<string, string, unknown, prismic.FieldState, "default" | "destructive" | "ghost" | "link" | "outline" | "secondary">>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type ImageWithTextSliceTwoColumn = prismic.SharedSliceVariation<"twoColumn", Simplify<ImageWithTextSliceTwoColumnPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type ImageWithTextSliceWithIcon = prismic.SharedSliceVariation<"withIcon", Simplify<ImageWithTextSliceWithIconPrimary>, never>;

/**
 * Slice variation for *ImageWithText*
 */
type ImageWithTextSliceVariation = ImageWithTextSliceDefault | ImageWithTextSliceTwoColumn | ImageWithTextSliceWithIcon
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type RecentsSliceDefault = prismic.SharedSliceVariation<"default", Simplify<RecentsSliceDefaultPrimary>, never>;
...
export interface RecentsSliceLocationPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/select
	 */
	location: prismic.SelectField<"Burnaby" | "Coquitlam" | "Delta" | "Langley" | "Maple Ridge" | "New Westminster" | "North Vancouver" | "Richmond" | "Surrey" | "Vancouver" | "West Vancouver" | "White Rock">;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type RecentsSliceLocation = prismic.SharedSliceVariation<"location", Simplify<RecentsSliceLocationPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type ReviewsSliceDefault = prismic.SharedSliceVariation<"default", Record<string, never>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type ReviewsSliceManual = prismic.SharedSliceVariation<"manual", Simplify<ReviewsSliceManualPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type ScrollerSliceCarousel = prismic.SharedSliceVariation<"carousel", Simplify<ScrollerSliceCarouselPrimary>, Simplify<ScrollerSliceCarouselItem>>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type ScrollerSlice = prismic.SharedSlice<"scroller", ScrollerSliceVariation>;
